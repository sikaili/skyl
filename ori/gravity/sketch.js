...
function setup() {
  ...
  Array(5).fill('').map((a,i)=>{atrs[i] = new Attractor(random(0,width), random(0,height), random(0,200),random(50,200))});
...
function draw() {
  ...
  if (state == -1) {
    ...
    textSize(30)
    textAlign(CENTER)
    text("Please drag to interact...", 0.5 * windowWidth, windowHeight*0.8)
    pop()
  }
