...
function toysDisplay() {
  ...
  t[5] = createA("http://forces.skyl.fr", "Gravity    万 有引力");
  t[4] = createA("http://unsustainable.skyl.fr", "Unsustainable      回 授");
  t[3] = createA("http://testa.skyl.fr", "Toxic    毒 ");
  t[1] = createA("http://eyes.skyl.fr", "Eyes    眼");
  t[2] = createA("http://line.skyl.fr", "Draw      画");
  t[0] = createA("http://myss.skyl.fr", " Where's Jane Joe      地点");
...
function drawingsDisplay() {
  ...
  d[0] = createA("https://www.instagram.com/skyl.fr/", "Drawings");
